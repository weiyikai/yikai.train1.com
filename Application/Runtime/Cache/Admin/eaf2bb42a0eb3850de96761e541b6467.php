...
<fieldset class="layui-elem-field site-demo-button" style="margin-top: 30px;margin-left: 20px;margin-right: 20px;">
    ...
    <div style="margin-left: 20px;margin-right:20px;margin-top: 20px;">
        <table class="table table-hover" width="100%" id="tbl_trainsInfo">
            ...
            <?php if(is_array($trainsInfoList)): foreach($trainsInfoList as $key=>$pv): ?><tr>
                    <th class="tid1"><?php echo ($pv["id"]); ?></th>
...
<script>
    ...
    $('#trainsInfoAdd').click(function () {
        $.post('<?php echo (C("view_url_base")); ?>/Admin/Business/showTrainsInfoAdd',{},function (result) {
    ...
    */
    ...
    $('.trainsInfoDel').click(function () {
        layer.confirm('确定删除此车次信息？', {
            ...
            $.post('<?php echo (C("view_url_base")); ?>/Admin/Business/doTrainsInfoDel',{
                tid:tid
            },function (result) {
                if (result.status === 200) {
