...
<fieldset class="layui-elem-field site-demo-button" style="margin-top: 30px;margin-left: 20px;margin-right: 20px;">
    ...
    <fieldset class="layui-elem-field site-demo-button" style="margin-top: 30px;margin-left: 20px;margin-right: 20px;">
        ...
        <div style="width: 70%;margin-left: 160px;text-align: center;">
            <blockquote class="layui-elem-quote"><span class="red" style="font-size: 50px;"><?php echo ($order_money); ?></span>火车币</blockquote>
            <blockquote class="layui-elem-quote">
                ...
                请在<span class="red">15</span>分钟内内完成支付，否则系统将自动为您取消本次订单。</blockquote>
        </div>
        <div style="width: 70%;margin-left: 160px;margin-top:20px;margin-bottom:20px;text-align: center;">
            <button class="layui-btn">马上支付</button>
            <button class="layui-btn layui-btn-warm">拍错重选</button>
