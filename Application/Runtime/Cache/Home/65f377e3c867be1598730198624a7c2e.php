...
<a id="login_user" href="<?php echo (C("view_url_base")); ?>/User/login" class="colorA" style="margin-left:-0.5px;">登录</a>
            ...
            <span class="login-txt" style="color:#666666;">
                ...
                |<span>剩余</span>
                <a id="my_info" href="<?php echo (C("view_url_base")); ?>/Business/remainMoney"><span class="red"><?php echo (session('money')); ?></span></a>
                <span>个火车币</span>
    ...
    <div class="nav">
        <ul>
            ...
            <li><a href="<?php echo (C("view_url_base")); ?>/Business/myorder" class="">我的订单</a>
             </li>
