...
<div class="header"><div style="z-index: 2000" class="header-bd"><a href="http://www.12306.cn/"><h1 class="logo">中国铁路客户服务中心-客运中心</h1>
    ...
    <div class="login-info"><div class="phone-link">
        ...
        <span class="login-txt" style="color: #666666"><span>
          您好，请</span>
<a id="login_user" href="<?php echo (C("view_url_base")); ?>/Login/login" class="colorA" style="margin-left:-0.5px;">登录</a>
| <a id="regist_out" style="color: #02b902" href="/otn/regist/init">注册</a>
            | <a id="login_out" class="colorA" href="/otn/regist/init">注销</a>
</span>
    </div>
    <div class="nav">
        <ul>
