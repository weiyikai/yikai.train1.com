    ...
    <div class="nav">
        <ul>
            ...
            <li id="selectYuding"><a href="/otn/leftTicket/init" class="">我的订单</a>
             ...
             <li><a href="<?php echo (C("view_url_base")); ?>/Pay/index" class="">充值中心</a>
             </li>
            <li><a href="https://cx.12306.cn/tlcx/index.html" target="_blank" class="">消息中心</a>
            </li>
            <li><a href="https://exservice.12306.cn/excater/index.html" target="_blank" class="">余额查询</a>
             </li>
